...
export default function Legacy() {
  ...
  return (
    <section
      id="legacy"
      ref={sectionRef}
      className="relative bg-void lg:h-[300vh]"
    >
      {/* =========================================================
      ...
      <div className="lg:hidden py-16 px-6">
        ...
        <motion.div
          ...
          className="mb-24"
        >
          <p className="annotation mb-5 text-champagne/60">
        ...
        >
          ...
          <h3 className="font-display text-3xl font-bold leading-[0.95] tracking-[-0.045em] text-bone">
            Where nature,
            <br />
            technology, and
            <br />
